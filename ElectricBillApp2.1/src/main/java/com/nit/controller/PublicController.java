...
public class PublicController {
	...
	@PostMapping("/login")
	public ResponseEntity<ApplicantRegister> login(@RequestBody ApplicantRegister app)
	{
		ApplicantRegister loginApplicant = appService.loginApplicant(app);
		System.out.println("hiii "+loginApplicant);
		return new ResponseEntity<ApplicantRegister>(loginApplicant, HttpStatus.OK);
	}
}
